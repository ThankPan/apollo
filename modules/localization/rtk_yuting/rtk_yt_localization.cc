...
void RTKYTLocalization::InitConfig(const rtk_config::Config &config) {
...
void RTKYTLocalization::GpsCallback(
...
void RTKYTLocalization::GpsStatusCallback(
...
void RTKYTLocalization::ImuCallback(
...
bool RTKYTLocalization::IsServiceStarted() { return service_started_; }

void RTKYTLocalization::GetLocalization(LocalizationEstimate *localization) {
  *localization = last_localization_result_;
}

void RTKYTLocalization::GetLocalizationStatus(
    LocalizationStatus *localization_status) {
  *localization_status = last_localization_status_result_;
}

void RTKYTLocalization::RunWatchDog(double gps_timestamp) {
...
void RTKYTLocalization::PrepareLocalizationMsg(
...
void RTKYTLocalization::FillLocalizationMsgHeader(
...
void RTKYTLocalization::FillLocalizationStatusMsg(
...
void RTKYTLocalization::ComposeLocalizationMsg(
