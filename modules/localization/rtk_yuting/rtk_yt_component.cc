...
bool RTKYTLocalizationComponent::InitConfig() {
  ...
  // config_file_path_ is a member of ComponentBase and set in .dag file, Todo:
  // see how it passed This loads one .pb.txt info a proto object
...
void RTKYTLocalizationComponent::PublishPoseBroadcastTF(
...
void RTKYTLocalizationComponent::PublishPoseBroadcastTopic(
    const LocalizationEstimate& localization) {
